...
(def org "replikativ")
(def lib 'org.replikativ/spindel-tui)
...
(defn jar [_]
  ...
  (b/write-pom {:class-dir class-dir
                ...
                :basis basis
                :src-dirs ["src"]
                :scm {:url "https://github.com/replikativ/spindel-tui"
                      :connection "scm:git:git://github.com/replikativ/spindel-tui.git"
                      :developerConnection "scm:git:ssh://git@github.com/replikativ/spindel-tui.git"
                      :tag (str "v" version)}
                :pom-data [[:description "Reactive terminal UIs for Spindel — render-spin, controller-map, tree component, JLine sink, suspend/resume for child processes"]
                           [:url "https://github.com/replikativ/spindel-tui"]
                           [:licenses
                            [:license
